...
import { useCreateSectionMutation, useUpdateSectionMutation } from '@/services/sections.api';
...
export function SectionModal({ isOpen, onClose, section, onSuccess }: SectionModalProps) {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (section) {
                await updateSection({ key: section.section_key, data: payload }).unwrap();
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-4 overflow-y-auto py-4">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="section-key" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                                    Section Key
                                </label>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="section-type" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                                    Section Type
                                </label>
                                <div className="flex items-center justify-between p-4 bg-[#F8FAFB] rounded-lg border border-[#DFE1E7]">
                                    <select
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="section-title" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                                    Title
                                </label>
                                <div className="flex items-center justify-between p-4 bg-[#F8FAFB] rounded-lg border border-[#DFE1E7]">
                                    <input
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="section-subtitle" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                                    Subtitle
                                </label>
                                <div className="flex items-center justify-between p-4 bg-[#F8FAFB] rounded-lg border border-[#DFE1E7]">
                                    <input
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="background-image-url" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="section-sort-order" className="text-[#777980] font-inter text-base font-normal leading-[130%]">
                                    Sort Order
                                </label>
                                <div className="flex items-center justify-between p-4 bg-[#F8FAFB] rounded-lg border border-[#DFE1E7]">
                                    <input
