            ...
            {isExportOpen && (
              <div className="absolute right-0 top-full mt-1 min-w-[180px] sm:min-w-[200px] bg-white rounded-lg border border-[#E8E8E9] shadow-lg z-50 overflow-hidden">
                <button
                  ...
                  className="flex w-full py-2.5 px-4 items-center text-xs sm:text-sm text-[#1B1B1B] hover:bg-[#F8FAFB] transition-colors"
                >
                  Export as Excel (.xlsx)
                </button>
                <button
                  onClick={handleExportCSV}
                  className="flex w-full py-2.5 px-4 items-center text-xs sm:text-sm text-[#1B1B1B] hover:bg-[#F8FAFB] transition-colors border-t border-[#E8E8E9]"
                >
                  Export as CSV (.csv)
                </button>
              </div>
