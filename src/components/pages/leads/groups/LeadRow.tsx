...
export function LeadRow({
  ...
  return (
    <tr className="border-t border-[#E8E8E9] bg-white hover:bg-[#F8FAFB] transition-colors X">
      ...
      <td className="py-2.5 px-4 border-r border-[#E8E8E9]">
        <span
          className={`inline-flex py-1.5 px-2 justify-center items-center gap-1 rounded border text-xs capitalize ${depositStatusStyles[lead.depositStatus] || depositStatusStyles.NONE}`}
        >
          {lead.depositStatus}
        </span>
      </td>
